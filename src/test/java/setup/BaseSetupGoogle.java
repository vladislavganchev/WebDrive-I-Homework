...
public class BaseSetupGoogle {
    ...
    public static void consentCookies(String agreeButtonId) {
        WebElement agreeButton = driver.findElement(By.id(agreeButtonId));
        agreeButton.click();
    }

    public static void typeSearchText (String searchFieldId) {
        WebElement searchField = driver.findElement(By.name(searchFieldId));
        searchField.sendKeys(SEARCH_ITEM);
    }

    public static void submitSearch (String searchButtonName) {
